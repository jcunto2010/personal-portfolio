...
const matchingCriteria = [
  ...
  { id: 'industry', label: 'Industry', explanation: 'Aligns users by sector expertise ΓÇö fintech founders meet fintech investors.' },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
          ...
          <div className="text-center mb-16">
            ...
            <p className="animate-fade-in-up text-gray-400 text-lg md:text-xl max-w-2xl mx-auto font-body" style={{ animationDelay: '0.5s', animationFillMode: 'both' }}>
              LinkedIn meets Tinder ΓÇö a social network for the startup ecosystem with swipe-based matching and community collaboration
            </p>
          </div>
            ...
            <div className="space-y-12">
              ...
              <div className="flex items-start gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-lg">Share milestones, celebrate wins, and stay updated on the startups you follow ΓÇö LinkedIn-style.</p>
                </div>
              </div>
